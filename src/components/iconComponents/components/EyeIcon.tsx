...
export const EyeIcon: FC<IIconProps> = (props): ReactElement => {

    const { fill, height, width } = props;

    return (
        <svg width={width} height={height} fill={fill}  version="1.1" id="_x32_" viewBox="0 0 512 512" >
            <g>
                <path d="M507.478,240.457C453.009,145.31,360.704,82.72,255.999,82.72c-104.706,0-197.008,62.59-251.477,157.737
                    ...
                    c64.045,0,115.969,51.924,115.969,115.969S320.044,373.295,255.999,373.295z"/>
                <path d="M255.999,180.381c-12.637,0-24.399,3.342-34.912,8.746l28.336,64.217l-65.262-22.947
                    c-3.156,8.404-5.109,17.418-5.109,26.932c0,42.473,34.475,76.948,76.948,76.948c42.474,0,76.947-34.475,76.947-76.948
                    S298.474,180.381,255.999,180.381z"/>
            </g>
        </svg>
    );
}